...
[^2]: Please note that [SLM-Lab](https://slm-lab.gitbook.io/slm-lab/), is the library that accompanies [this book](https://www.amazon.com/Deep-Reinforcement-Learning-Python-Hands/dp/0135172381). You will learn a lot by reviewing the implementations under the ``agents/algorithms`` directory to get a feel of how RL problems are abstracted .  
